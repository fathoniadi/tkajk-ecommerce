<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="index.php">Camping.in Aja<span>Vacation Solution</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li class="dropdown ">
								<a href="#" class="dropdown-toggle  hyper" data-toggle="dropdown" ><span>Camping<b class="caret"></b></span></a>
							...
							<li class="dropdown">
								...
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span> Traveling<b class="caret"></b></span></a>
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span>Climbing<b class="caret"></b></span></a>
							...
							<li><a href="codes.html" class="hyper"> <span>Daypack</span></a></li>
							<li><a href="contact.html" class="hyper"><span>Agent Travel</span></a></li>
						</ul>
					</div>
					</nav>
					 <div class="cart" >
