...
<!--content-->
		...
		<div class="container">
			...
			<div class=" con-w3l agileinf">
				<div class=" con-w3l" class="pull-center">
							<div class="col-md-3 m-wthree">
								<div class="col-m">								
									<a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
										<img src="images/tkajk/sepatu/1.jpg" style="height: 100px" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Sepatu Gunung Rei</a></h6>							
										</div>
										<div class="mid-2">
											<p ><label>Rp. 900.000</label><em class="item_price">Rp. 750.000</em></p>
											  <div class="block">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal2" class="offer-img">
										<img src="images/tkajk/sepatu/2.jpg" style="height: 100px" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Sepatu Gunung Consina</a></h6>							
										</div>
										<div class="mid-2">
											<p ><label>Rp. 900.000</label><em class="item_price">Rp. 750.000</em></p>
											  <div class="block">
