...
<div class="banner-top">
	<div class="container">
		<h3 >Sepatu</h3>
		<h4><a href="index.html">Home</a><label>/</label>Sepatu</h4>
...
<div id="picture-frame">
			<img src="images/tkajk/sepatu/1.jpg" data-src="images/si-1.jpg" alt="" class="img-responsive"/>
		</div>
			...
			<div class="col-md-7 single-top-left ">
				...
				<h3>Sepatu Outdoor Rei</h3>
				
					
				 <div class="pr-single">
				  <p class="reduced "><del>Rp 900.000</del>Rp 750.000</p>
				</div>
